...
function href(cb, root) {
  ...
  assert$4.equal(typeof root, "object", "nanohref: root should be type object");
...
ChooComponentCache.prototype.render = function(Component, id) {
  ...
  assert$1.ok(typeof id === "string" || typeof id === "number", "ChooComponentCache.render: id should be type string or type number");
    ...
    if (self._hrefEnabled) {
      nanohref(function(location) {
        ...
        if (href2 === window.location.href) {
          if (!self._hashEnabled && hash2)
            scrollToAnchor(hash2);
          return;
        }
        self.emitter.emit(self._events.PUSHSTATE, href2);
      });
    }
  }
...
Photo: Stathis Doganis
  ...
  },
  {
    ...
    title: html$1`<a href="https://archive.glitches.me" target="_blank">archive.glitches.me</a>`,
    type: ["lecture"],
    topic: ["dance"],
...
<p>
  ...
  },
  {
    ...
    title: html$1`<a href="https://stage.glitches.me" target="_blank">stage.glitches.me</a>`,
    type: ["performance"],
    topic: ["dance"],
...
The work is created within the framework of the MODINA project.
  ...
  },
  {
    ...
    links: [],
    desc: html$1`<div><i>Who is Naoto Hieda? Seems to me, is the essential, existential question that Naoto ask themself in every new artistic endeavor they engage into.</i> - Camilo Sandoval<br /><br />
  ...
  },
  {
    ...
    desc: html$1`Photo: Susse Seppälä
    `
  },
  {
...
`
  ...
  },
  {
    ...
    desc: html$1`Photo: Doerthe Boxberg
    `
  },
  {
    start: /* @__PURE__ */ new Date("July 19, 2023"),
  ...
  },
  {
    ...
    desc: html$1`Photo: Bente Stachowske
    `
  },
  {
  ...
  },
  {
    ...
    title: html$1`<a href="https://solo.glitches.me" target="_blank">solo.glitches.me</a>`,
    type: ["performance"],
    topic: ["net art"],
    collab: ["Naoto Hieda"],
  ...
  },
  {
    ...
    title: html$1`<a href="https://soup.glitches.me" target="_blank">soup.glitches.me</a>`,
    type: ["installation"],
    topic: ["net art"],
    collab: ["Naoto Hieda"],
  ...
  },
  {
    ...
    image: "https://cdn.glitch.global/cada0ae2-f902-428d-81e3-6a68f5e589e5/domeworkshop.jpg?v=1667689998296",
    desc: html$1`
  ...
  },
  {
    ...
    title: html$1`<a href="https://riso.glitches.me" target="_blank">riso.glitches.me</a>`,
    type: ["installation"],
    topic: ["risograph"],
    collab: ["Naoto Hieda"],
...
Sponsored by Processing Community Japan (PCJ)
  ...
  },
  {
    ...
    venue: "ICLC (online)",
    links: ["https://iclc.toplap.org/2021/exhibition.html"],
    image: "https://cdn.glitch.com/9b37fb18-5c29-4916-b8ad-624764fa77cb%2F201218-codame.jpg?v=1608479114980",
    yt: "Fas_pGA2tvk",
    desc: html$1`
    `
  },
  ...
  },
  {
    ...
    image: "https://cdn.glitch.com/cada0ae2-f902-428d-81e3-6a68f5e589e5%2Frh.png?v=1630336603964",
    yt: "6jxm8a3hoQE",
    venue: "Dusseldorfer Schauspielhaus (Germany)",
    desc: html$1`Camera: Naoto Hieda
    `
  },
  {
    ...
    desc: html$1`Software Development: Naoto Hieda
    `,
  ...
  },
  {
    ...
    desc: html$1`Exhibition design: Rosi Grillmair`
  },
  {
    start: /* @__PURE__ */ new Date("July 21, 2021"),
  ...
  },
  {
    ...
    desc: html$1`Naoto Hieda and Jorge Guevara have been practicing over a year, and for the first #bestpracticesincontemporarydance exhibition, they installed a triptych of their practice featuring variety of #underconstruction gifs in a construction site.`
  },
  {
    start: /* @__PURE__ */ new Date("July 21, 2021"),
    title: "netze.khm.de",
  ...
  },
  {
    ...
    desc: html$1`“Six Small Sketches” is a collection of 6 small sketches that is
...
Published by Bad Quarto`
  },
  {
    ...
    desc: html$1`photo credit @konstantinjohanneshehl`
  },
  {
    ...
    desc: html$1`Choreography, interpretation and concept: Raphael Hillebrand<br>
  ...
  },
  {
    ...
    desc: html$1`Workshop at SUNY invited by Lee Tusman`
  },
  {
    ...
    desc: html$1`Organization, curation, talk and workshop: Naoto Hieda<br>
...
Exhibited as part of "ctrl+space" by Christian Sievers`
  ...
  },
  {
    ...
    collab: ["Flor de Fuego", "Naoto Hieda"],
    venue: "CCFest (online)",
    image: "https://cdn.glitch.com/cada0ae2-f902-428d-81e3-6a68f5e589e5%2Fvlcsnap-2021-01-24-22h54m34s826.png?v=1611525647011",
  ...
  },
  {
    ...
    image: "https://cdn.glitch.com/9b37fb18-5c29-4916-b8ad-624764fa77cb%2F201220-tidal.jpg?v=1608503105807",
    yt: "gN9DHCetfBE",
    desc: html$1`
  ...
  },
  {
    ...
    collab: ["Flor de Fuego", "Ritchse", "Naoto Hieda", "Olivia Jack"],
    venue: "online",
    image: "https://cdn.glitch.com/9b37fb18-5c29-4916-b8ad-624764fa77cb%2Fhydra-meetup1.png?v=1604872115474",
  ...
  for (const l of list) {
    if (filter2 != void 0) {
      if (filter2.tag != void 0) {
        if (filter2.tag != "all" && l.type.indexOf(filter2.tag) < 0)
          continue;
      }
      if (filter2.year != void 0) {
        if (filter2.year != "all" && l.dateYear != filter2.year)
          continue;
      }
    }
    newList.push(l);
...
function main(state, emit) {
  ...
  const contents = filter(state.contents, state.filter).map((s) => {
    ...
    let link = [];
    if (yt != void 0) {
      link.push(html$1`<a target="_blank" href="https://youtu.be/${yt}">Video</a>`);
    }
    for (let i = 0; links !== void 0 && i < links.length; i++) {
      ...
      link.push(html$1`<div><a target="_blank" href="${links[i]}">Link ${num}</a></div>`);
    }
    let collabs = [];
    if (collab != void 0) {
      let i = 0;
    ...
    if (image != void 0) {
      ...
      imageElt = html$1`<p>The image is currently on loan</p>`;
    }
    return html$1`
